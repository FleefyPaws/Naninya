...
class Canvacord {
    ...
    async rank(
        ...
        ctx.fillStyle = color || '#FFFFFF';
        ctx.textAlign = 'end';
        ctx.fillText(934 - 64 - ctx.measureText(level).width - 16 - ctx.measureText(`LEVEL`).width - 16, 82);
        ctx.fillStyle = color || '#FFFFFF';
    ...
    async welcome({
        ...
        ctx.fillText('Welcome! Have a great time!', 260, 100);
